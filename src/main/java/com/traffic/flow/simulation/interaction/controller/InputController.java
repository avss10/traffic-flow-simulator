...
import com.traffic.flow.simulation.interaction.handler.GenerateBtnHandler;
import com.traffic.flow.simulation.interaction.handler.SimulationBtnHandler;
import java.awt.*;
...
//    private String[] genTypes = {"Data-space oriented approach(DSO)", "Network-based approach(NB)"};
    private String[] genTypes = {"Data-space oriented approach(DSO)"};
    ...
    public InputController(
            MainController cc, OutputController rc, SparkSession spark, String appTitle) {
        this.inputPanel = inputPanel(cc, rc, spark, appTitle);
    }

    private JPanel inputPanel(
            final MainController cc, OutputController rc, SparkSession spark, String appTitle) {
        // Top panel
        JPanel topPanel = new JPanel();
        topPanel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));

        JLabel label = new JLabel("TrafficFlowSim");
        ...
        try {
            ...
            LOG.warn("TrafficFlowSim logo can't be load", e);
        }
        ...
        JButton vBtn = new JButton("Show Simulation");
