...
import com.traffic.flow.simulation.model.{Intersect, Link, SegmentLink, SegmentNode, TrafficLight}
import com.vividsolutions.jts.algorithm.Angle
import com.vividsolutions.jts.geom.{Coordinate, GeometryFactory, Point}
import com.traffic.flow.simulation.model.{Intersect, Link, TrafficLight}
import com.traffic.flow.simulation.model.SegmentLink
...
object OsmConverter {
  ...
  /**
    * Convert road network to simulation type of road network in TrafficFlowSim
    *
    * @param sparkSession the spark session
    * @param path road network source
